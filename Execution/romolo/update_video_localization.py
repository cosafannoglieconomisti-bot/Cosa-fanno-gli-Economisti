...
def update_video_localizations(youtube, video_id, intl_root):
    ...
    for lang in languages:
        ...
        if title and desc:
            ...
            print(f"⚠️ Metadati {lang} non validi in {md_file}")
...
def upload_captions(youtube, video_id, intl_root):
    ...
    for lang in languages:
        ...
        if not os.path.exists(srt_file): continue
...
if __name__ == "__main__":
    ...
    update_video_localizations(service, args.video_id, args.intl_path)
    upload_captions(service, args.video_id, args.intl_path)
