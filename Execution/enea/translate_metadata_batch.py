...
def translate_metadata(project_name):
    it_md = os.path.join("/Users/<USER>/Desktop/canale/Cleaned", project_name, "video_metadata.md")
    ...
    for lang_code, lang_name in LANGS.items():
        out_path = os.path.join("/Users/<USER>/Desktop/canale/Cleaned", project_name, "international", lang_code, f"metadata_{lang_code}.md")
